...
intensity or efficiency fluctuates \todo{upto 50\%? due to LED or PMT?}.
...
\todo{add nice photo/schematic of setup} has been adapted to support the
...
unable to supply the current quickly enough.
...
foot/power supply/.. of the \pmt failed, while the tubes were still
working fine. The costs to replace the power supply were to excessive.
The \nikhef Electronics department which also developed the \hisparc
electronics has been working on \pmt power supplies for the KM3Net
neutrino telescope experiment. The KM3Net \pmts have other requirements
than those used for \hisparc so modifications were required. The KM3Net
design has been modified to be suitable for \hisparc. There have been a
couple of iteration of the \hisparc \pmts. Multiple \pmts of each of
...
\todo{Perform test for multiple \pmts of each type; old et, first
      print, and second print}
